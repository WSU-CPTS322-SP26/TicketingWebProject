      ...
      {!showAnimation && (
        <div className="frame">
          ...
          <div className="navbar">
            <div className="offers-promotions" onClick={() => navigate ('/offers')} style={{cursor: 'pointer'}}>
              Offers & Promotions
            </div>

            {/* ✅ Only change: added onClick to navigate to /movies */}
            <div className="text-wrapper-2" onClick={() => navigate('/movies')} style={{ cursor: 'pointer' }}>
              Movies
            </div>
